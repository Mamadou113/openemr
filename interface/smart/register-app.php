...
<form id="app_form" method="POST" autocomplete="off">
    <div class="<?php echo $loginrow; ?> card m-5">
        <div class="<?php echo attr($logoarea); ?>">
            ...
            <?php } ?>
            <p class="text-center lead font-weight-normal login-bg-text-color text-white"><?php echo xlt('AI-Integrated Universal Health System An OpenEMR Based Solution.'); ?></p>
